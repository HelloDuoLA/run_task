...
# 2. 向前观察零食
230, -170, 525, 90, 0, 90
# ml.send_base_coords([230, 170, 550, -90, 0.0, -90],50)
# ml.send_angles([-73.55, 20.54, -125.41, 120.18, 73.91, 33.96],50)
...
# 2. 向前观察零食
# mr.send_base_coords([230, -170, 550, 90, 0, 90],50)
# mr.send_angles([73.55, 20.54, -125.41, -120.18, 73.91, -33.96],50)
