...
# 向下观察食品框
# ml.send_base_coords([330, 205, 435, -180, 0.0, -90],50)
# ml.send_angles([-63.2, 26.86, -76.82, 64.8, 29.83, 31.53],50) 

# 2. 向前观察零食
# ! 和右臂不一样了
# ml.send_base_coords([160, 250, 360, -90, 0.0, -90],50)
# ml.send_angles([-108.34, -16.51, -151.6, 101.01, 56.86, 53.15],50)
...
# 3. 向前观察零食
# mr.send_base_coords([160, -140, 360, 90, 0, 90],50)
# mr.send_angles([88.46, 13.94, -152.88, -98.96, 61.21, -15.06],80)
