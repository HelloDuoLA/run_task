...
# 识别咖啡机 开机 
# ml.send_base_coords([220.0, 80.0, 450.0, -90, 0.0, -90],50)
# ml.send_angles([-54.14, 34.18, -145.1, 126.18, 60.41, 0.66],50)
...
# 2. 向下观察食品框
# mr.send_base_coords([330, -150, 550, -180, 0.0, 90],100)
# mr.send_angles([55.88, 38.52, -76.22, -58.23, 41.24, -20.51],50)
