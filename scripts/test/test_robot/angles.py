...
# 向下观察食品框
# ml.send_base_coords([330, 220, 550, -180, 0.0, -90],50)
# ml.send_angles([-61.41, 28.64, -76.33, 64.55, 31.97, 30.71],50) 


# 2. 向前观察零食
# ! 和右臂不一样了
# ml.send_base_coords([180, 320, 450, -90, 0.0, -90],50)
# ml.send_angles([-111.16, -26.61, -145.64, 109.46, 58.93, 72.15],50)
...
# 识别咖啡机 开机 
# ml.send_base_coords([220.0, 130.0, 450.0, -90, 0.0, -90],50)
# ml.send_angles([-60.67, 17.05, -152.33, 123.97, 65.58, 10.15],50)
...
# 2. 向下观察食品框
# mr.send_base_coords([330, -100, 550, -180, 0.0, 90],100)
# mr.send_angles([52.42, 47.88, -71.7, -57.29, 46.42, -17.02],50)

# 3. 向前观察零食
# mr.send_base_coords([180, -140, 450, 90, 0, 90],50)
# mr.send_angles([75.23, 19.93, -156.01, -106.96, 61.11, -4.48],80)
