...
class Asr_node():
    def __init__(self) -> None:
        ...
        self.initial_prompt = (
            ...
            "执行一次送货的操作就是ADD；table_id包括1、2，其中一号办公桌或者办公桌一赋值为1，二号办公桌或者办公桌二赋值为2；"
            ...
            "我的送货任务是：假如你是机器人，我对机器人说一段话，将一个果冻放到办公桌一上，然后你要识别出其中的关键信息，"
            "一个、果冻、办公桌一，并按照之前跟你描述的json对象格式一一填入，如果某个对象没有，都要一起返回，"
            ...
            "如果我的指令是：拿一个果冻和一个益达口香糖到办公桌一上，你要生成如下的json内容："
            "{\n"
            "    \"order_operation\": 0,\n"
            "    \"table_id\": 1,\n"
            "    \"snacks\": {\n"
            ...
            "    }\n"
            "}\n"
            "要像上面那样，snacks中的对象\"1\"填入值为2,对象\"2\"填入值为1,其他均为0。"
